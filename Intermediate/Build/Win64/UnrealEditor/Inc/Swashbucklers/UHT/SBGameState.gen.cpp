...
// End Cross Module References
	...
	DEFINE_FUNCTION(ASBGameState::execMulticastBuildingDestroyed)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MulticastBuildingDestroyed_Implementation(EBuildingType(Z_Param_BuildingType),Z_Param_BuildingDestroyed);
		P_NATIVE_END;
	}
	...
	void ASBGameState::MulticastBuildingDestroyed(EBuildingType BuildingType, ABuilding* BuildingDestroyed)
	{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASBGameState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASBGameState_ClientPlayerKilled, "ClientPlayerKilled" }, // 2478837434
		{ &Z_Construct_UFunction_ASBGameState_ExtraHeartPiece, "ExtraHeartPiece" }, // 140478479
		{ &Z_Construct_UFunction_ASBGameState_MulticastBuildingDestroyed, "MulticastBuildingDestroyed" }, // 1153818499
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Swashbucklers_Source_Swashbucklers_Public_GameStates_SBGameState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASBGameState, ASBGameState::StaticClass, TEXT("ASBGameState"), &Z_Registration_Info_UClass_ASBGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASBGameState), 2002431053U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Swashbucklers_Source_Swashbucklers_Public_GameStates_SBGameState_h_1294226777(TEXT("/Script/Swashbucklers"),
